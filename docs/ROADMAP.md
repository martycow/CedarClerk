...
- [ ] I12 — split Settings into profile / appearance / rest. `I14` already took appearance and toolbar out, so what's left to split is profile / header slots / social / billing / integrations — smaller than when this was written. Still open
