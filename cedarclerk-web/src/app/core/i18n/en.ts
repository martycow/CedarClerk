...
export const en = {
    ...
    manager: {
        ...
        forms: {
            ...
            answersMoved: 'Answers and their distribution are on the Posts tab, under the post itself.',
            presetsHint: 'Presets exist on their own — build one here, then pick it before publishing a post.',
            presetNeedsForm: 'Open a post\'s form above to save it as a preset.',
            applyPreset: 'Apply to the open form',
            applyPresetNeedsForm: 'Open a post\'s form first',
            saved: 'Saved',
            unsaved: 'Unsaved changes',
