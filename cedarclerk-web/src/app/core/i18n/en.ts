...
export const en = {
    ...
    drafts: {
        ...
        importProcessing: 'Processing on the server…',
        viewTable: 'Table',
        viewGrid: 'Grid',
        folders: {
        ...
        errors: {
            ...
            create: 'Failed to create draft',
            import: 'Import failed — check the file and try again',
            importStalled: 'Upload stalled — the connection dropped, try again',
            importTooLarge: 'The file was rejected before reaching the server (usually a proxy/tunnel upload-size limit, often around 100MB — the app itself allows up to 200MB). Shrink the archive (compress or drop some images) and try again.',
    ...
    editor: {
        ...
        exportModal: {
            ...
            disableCopy: 'Disable text copying',
            disableCopyHint: 'Selection, copying and the context menu are blocked on the blog post page. A deterrent, not protection — the page source stays reachable.',
            ...
            // DB1 (same meaning as manager.forms.noPresetsSaved) — this post already has a form
            // (the select above is populated), just no saved presets yet to pick a different one.
    ...
    manager: {
        ...
        forms: {
            ...
            typeMulti: 'Several',
            typeConsent: 'Consent',
            consentPlaceholder: 'Agreement text, e.g. "I agree to the rules"',
            consentHint: 'The reader sees the text with a checkbox below it — access stays locked until they tick it.',
            required: 'Required',
            ...
            removeLang: 'Remove language (its texts are deleted)',
            translateLang: 'Auto-translate from the primary language',
            languageHint: 'One form carries every language: each question and option gets a per-language field, and "Да" and "Yes" count as one answer in the stats. Readers without their language see the primary one.',
        ...
        errors: {
            ...
            translatePreset: 'Failed to translate the form',
        },
    },
    glossary: {
        crumb: 'Glossary',
