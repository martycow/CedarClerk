...
namespace CedarClerk.Server.Migrations
{
    ...
    [Migration("20260729201224_AddDraftDisableCopy")]
    partial class AddDraftDisableCopy
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CedarClerk.Server.AdminAuditEntry", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("CedarClerk.Server.ApplicationUser", b =>
                {
                    ...
                    b.Property<string>("BlogLinkTextTranslationsJson")
                        .HasColumnType("TEXT");
                    ...
                    b.Property<byte>("PlanTier")
                        .HasColumnType("INTEGER");

                    b.Property<string>("PostSignature")
                        .HasColumnType("TEXT");

                    b.Property<string>("PostSignatureTranslationsJson")
                        .HasColumnType("TEXT");
                    ...
                    b.Property<string>("TelegramLinkText")
                        .HasColumnType("TEXT");

                    b.Property<string>("TelegramLinkTextTranslationsJson")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("CedarClerk.Server.Asset", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("CedarClerk.Server.BotKnownChat", b =>
                {
                    ...
                    b.ToTable("BotKnownChats");
                });

            modelBuilder.Entity("CedarClerk.Server.BotKnownChatAdmin", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");

                    b.Property<Guid>("BotKnownChatId")
                        .HasColumnType("TEXT");
                    ...
                    b.HasIndex("BotKnownChatId", "TelegramUserId")
                        .IsUnique();
            ...
            modelBuilder.Entity("CedarClerk.Server.Comment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("CedarClerk.Server.Draft", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
                    ...
                    b.Property<bool>("IsListedWhilePrivate")
                        .HasColumnType("INTEGER");
                    ...
                    b.Property<string>("RegistrationFormTranslationsJson")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("CedarClerk.Server.GlossaryTerm", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("CedarClerk.Server.PollVote", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("CedarClerk.Server.ScheduledPost", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("CedarClerk.Server.BotKnownChatAdmin", b =>
                {
                    b.HasOne("CedarClerk.Server.BotKnownChat", "BotKnownChat")
                        .WithMany()
                        .HasForeignKey("BotKnownChatId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("BotKnownChat");
                });
            ...
            modelBuilder.Entity("CedarClerk.Server.ChannelStatSnapshot", b =>
                {
                    b.HasOne("CedarClerk.Server.Channel", "Channel")
                        .WithMany()
            ...
            modelBuilder.Entity("CedarClerk.Server.DraftTranslation", b =>
                {
                    b.HasOne("CedarClerk.Server.Draft", "Draft")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("CedarClerk.Server.ApplicationUser", null)
                        .WithMany()
